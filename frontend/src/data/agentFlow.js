...
export const agentFlowNodes = [
  ...
  { id: "guidance", label: "Guidance", detail: "Manager — narrates & decides", color: FLOW_COLORS.violet, role: "manager" },
  { id: "dashboard", label: "Dashboard Alert", detail: "Always surfaced to you", color: FLOW_COLORS.violet, role: "agent" },
...
export const agentFlowEdges = [
  ...
  { id: "guidance-dashboard", from: "guidance", to: "dashboard", color: FLOW_COLORS.violet, speed: 0.28, status: "active" },
