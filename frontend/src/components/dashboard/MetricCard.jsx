  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div>
          <p className="font-mono text-xs uppercase tracking-[0.14em] text-white/55">{meta.label}</p>
          <div className="mt-2 flex items-baseline gap-1.5">
            ...
            />
            {meta.unit && <span className="font-mono text-sm text-white/40">{meta.unit}</span>}
          </div>
        </div>
